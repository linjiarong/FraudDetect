#!/bin/sh
APP_VERSION=1.0.0
REPO_DOMAIN=501337207382.dkr.ecr.ap-east-1.amazonaws.com
cd ../ &&
...
aws ecr get-login-password --region ap-east-1 | docker login --username AWS --password-stdin $REPO_DOMAIN &&
